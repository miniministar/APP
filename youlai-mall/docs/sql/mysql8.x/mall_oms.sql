...
CREATE TABLE `oms_order`  (
  ...
  `order_sn` varchar(64) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '订单号',
  ...
  `remark` varchar(500) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '订单备注',
  ...
  `out_trade_no` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '微信支付等第三方支付平台的商户订单号',
  `transaction_id` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '微信支付订单号',
  `out_refund_no` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '商户退款单号',
  `refund_id` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '微信退款单号',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1351548262424821956 CHARACTER SET = utf8mb4 COMMENT = '订单详情表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `oms_order_delivery`  (
  ...
  `delivery_company` varchar(64) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '物流公司(配送方式)',
  `delivery_sn` varchar(64) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '物流单号',
  `receiver_name` varchar(100) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '收货人姓名',
  `receiver_phone` varchar(32) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '收货人电话',
  `receiver_post_code` varchar(32) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '收货人邮编',
  `receiver_province` varchar(32) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '省份/直辖市',
  `receiver_city` varchar(32) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '城市',
  `receiver_region` varchar(32) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '区',
  `receiver_detail_address` varchar(500) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '详细地址',
  `remark` varchar(500) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '备注',
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '订单物流记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `oms_order_item`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `order_id` bigint NOT NULL COMMENT '订单ID',
  `spu_name` varchar(128) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '商品名称',
  `sku_id` bigint NOT NULL DEFAULT 0 COMMENT '商品ID',
  `sku_sn` varchar(64) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '商品编码',
  `sku_name` varchar(128) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '规格名称',
  `pic_url` varchar(255) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '商品图片',
...
) ENGINE = InnoDB AUTO_INCREMENT = 210 CHARACTER SET = utf8mb4 COMMENT = '订单商品信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `oms_order_log`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `order_id` bigint NOT NULL COMMENT '订单id',
  `user` varchar(100) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '操作人[用户；系统；后台管理员]',
  `detail` varchar(255) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '操作详情',
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '订单操作历史记录' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `oms_order_pay`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `order_id` bigint NOT NULL COMMENT '订单id',
  `pay_sn` varchar(128) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '支付流水号',
  `pay_amount` bigint NOT NULL DEFAULT 0 COMMENT '应付总额(分)',
  `pay_time` datetime NULL DEFAULT NULL COMMENT '支付时间',
  ...
  `callback_content` varchar(500) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '回调内容',
  `callback_time` datetime NULL DEFAULT NULL COMMENT '回调时间',
  `pay_subject` varchar(200) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '交易内容',
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除【0->正常；1->已删除】',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '支付信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `oms_order_setting`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '订单配置信息' ROW_FORMAT = DYNAMIC;
