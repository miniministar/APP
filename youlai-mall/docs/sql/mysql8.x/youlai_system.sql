...
CREATE TABLE `sys_dept`  (
  ...
  `name` varchar(64) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '部门名称',
  `parent_id` bigint(0) NULL DEFAULT 0 COMMENT '父节点id',
  `tree_path` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '父节点id路径',
...
) ENGINE = InnoDB AUTO_INCREMENT = 160 CHARACTER SET = utf8mb4  COMMENT = '部门表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_dict_item`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `type_code` varchar(64) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '字典类型编码',
  `name` varchar(50) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '字典项名称',
  `value` varchar(50) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '字典项值',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4  COMMENT = '字典数据表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_dict_type`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键 ',
  `name` varchar(50) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '类型名称',
  `code` varchar(50) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '类型编码',
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4  COMMENT = '字典类型表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_menu`  (
  ...
  `name` varchar(64) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '菜单名称',
  `path` varchar(128) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '路由路径(浏览器地址栏路径)',
  `component` varchar(128) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '组件路径(vue页面完整路径，省略.vue后缀)',
  `perm` varchar(50) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '按钮权限标识',
  `icon` varchar(64) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '菜单图标',
  `sort` int(0) NULL DEFAULT 0 COMMENT '排序',
  `visible` tinyint(1) NULL DEFAULT 1 COMMENT '状态(0:禁用;1:开启)',
  `redirect` varchar(128) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '跳转路径',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = utf8mb4  COMMENT = '菜单管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_role`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '角色名称',
  `code` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '角色编码',
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4  COMMENT = '角色表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user`  (
  ...
  `avatar` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT '' COMMENT '用户头像',
  `mobile` varchar(20) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '联系方式',
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '用户状态((1:正常;0:禁用))',
  `email` varchar(128) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '用户邮箱',
...
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8mb4  COMMENT = '用户信息表' ROW_FORMAT = Dynamic;
