...
CREATE TABLE `sms_advert`  (
  ...
  `title` varchar(100) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '广告标题',
  `pic_url` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '图片地址',
  `begin_time` datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
  `status` tinyint(1) NOT NULL COMMENT '状态(1:开启；0:关闭)',
  `sort` int(0) NULL DEFAULT NULL COMMENT '排序',
  `redirect_url` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '跳转链接',
...
) ENGINE = InnoDB AUTO_INCREMENT = 67 CHARACTER SET = utf8mb4  COMMENT = '广告表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_coupon`  (
  ...
  `name` varchar(64) CHARACTER SET utf8mb4  NOT NULL COMMENT '优惠券名称',
  `type` tinyint(0) NOT NULL DEFAULT 1 COMMENT '优惠券类型(1-满减券;2-直减券;3-折扣券)',
  `code` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT '0' COMMENT '优惠券码',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4  COMMENT = '优惠券表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_coupon_history`  (
  ...
  `member_nickname` varchar(50) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '会员昵称',
  `coupon_code` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '优惠券码',
  ...
  `order_sn` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '订单号',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `sms_coupon_spu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1548148841429663756 CHARACTER SET = utf8mb4  ROW_FORMAT = Dynamic;
