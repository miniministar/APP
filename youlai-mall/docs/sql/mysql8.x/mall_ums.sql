...
CREATE TABLE `ums_address`  (
  ...
  `consignee_name` varchar(64) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '收货人姓名',
  `consignee_mobile` varchar(20) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '收货人联系方式',
  `province` varchar(64) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '省',
  `city` varchar(64) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '市',
  `area` varchar(64) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '区',
  `detail_address` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '详细地址',
  `zip_code` char(6) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '邮编',
...
CREATE TABLE `ums_member`  (
  ...
  `nick_name` varchar(50) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
  `mobile` varchar(20) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
  `birthday` date NULL DEFAULT NULL,
  `avatar_url` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
  `openid` char(28) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
  `session_key` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
  ...
  `city` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
  `country` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
  `language` varchar(10) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
  `province` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8mb4  ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `undo_log`  (
  ...
  `xid` varchar(100) CHARACTER SET utf8mb4  NOT NULL COMMENT 'global transaction id',
  `context` varchar(128) CHARACTER SET utf8mb4  NOT NULL COMMENT 'undo_log context,such as serialization',
  `rollback_info` longblob NOT NULL COMMENT 'rollback info',
  `log_status` int NOT NULL COMMENT '0:normal status,1:defense status',
  `log_created` datetime(6) NOT NULL COMMENT 'create datetime',
  `log_modified` datetime(6) NOT NULL COMMENT 'modify datetime',
  UNIQUE INDEX `ux_undo_log`(`xid`, `branch_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4  COMMENT = 'AT transaction mode undo table' ROW_FORMAT = DYNAMIC;
