...
CREATE TABLE `pms_brand`  (
                              ...
                              `name` varchar(64) CHARACTER SET utf8mb4 NOT NULL COMMENT '品牌名称',
                              `logo_url` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT 'LOGO图片',
                              `sort` int NULL DEFAULT NULL COMMENT '排序',
                              `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                              `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
                              PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8mb4  COMMENT = '商品品牌表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_category`  (
                                 `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
                                 `name` varchar(64) CHARACTER SET utf8mb4 NOT NULL COMMENT '商品分类名称',
                                 `parent_id` bigint NOT NULL COMMENT '父级ID',
                                 `level` int NULL DEFAULT NULL COMMENT '层级',
                                 `icon_url` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '图标地址',
                                 `sort` int NULL DEFAULT NULL COMMENT '排序',
                                 `visible` tinyint(1) NULL DEFAULT 1 COMMENT '显示状态:( 0:隐藏 1:显示)',
                                 `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                                 `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
                                 PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 102 CHARACTER SET = utf8mb4  COMMENT = '商品分类表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_category_attribute`  (
                                           ...
                                           `name` varchar(64) CHARACTER SET utf8mb4 NOT NULL COMMENT '属性名称',
                                           `type` tinyint NOT NULL COMMENT '类型(1:规格;2:属性;)',
                                           `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                                           `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
                                           PRIMARY KEY (`id`) USING BTREE,
                                           INDEX `fk_pms_attr_pms_category`(`category_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 183 CHARACTER SET = utf8mb4  COMMENT = '商品属性表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_sku`  (
                            ...
                            `sku_sn` varchar(64) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '商品编码',
                            `spu_id` bigint NOT NULL COMMENT 'SPU ID',
                            `name` varchar(128) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '商品名称',
                            `spec_ids` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '商品规格值，以英文逗号(,)分割',
                            ...
                            `pic_url` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '商品图片地址',
                            `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                            `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
                            PRIMARY KEY (`id`) USING BTREE,
                            INDEX `fk_pms_sku_pms_spu`(`spu_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 755 CHARACTER SET = utf8mb4  COMMENT = '商品库存表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_spu`  (
                            `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
                            `name` varchar(64) CHARACTER SET utf8mb4 NOT NULL COMMENT '商品名称',
                            ...
                            `pic_url` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '商品主图',
                            `album` json NULL COMMENT '商品图册',
                            `unit` varchar(16) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '单位',
                            `description` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '商品简介',
                            `detail` text CHARACTER SET utf8mb4 NULL COMMENT '商品详情',
...
) ENGINE = InnoDB AUTO_INCREMENT = 288 CHARACTER SET = utf8mb4  COMMENT = '商品表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_spu_attribute`  (
                                      ...
                                      `name` varchar(64) CHARACTER SET utf8mb4 NOT NULL COMMENT '属性名称',
                                      `value` varchar(128) CHARACTER SET utf8mb4 NOT NULL COMMENT '属性值',
                                      `type` tinyint NOT NULL COMMENT '类型(1:规格;2:属性;)',
                                      `pic_url` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '规格图片',
                                      `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                                      `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
                                      PRIMARY KEY (`id`) USING BTREE,
                                      INDEX `fk_pms_spu_attribute_pms_attr`(`name` ASC) USING BTREE,
                                      INDEX `fk_pms_spu_attribute_pms_spu`(`spu_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 847 CHARACTER SET = utf8mb4  COMMENT = '商品属性/规格表' ROW_FORMAT = DYNAMIC;
